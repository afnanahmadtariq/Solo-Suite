  ...
  template: `
    ...
    >
      ...
      <div class="p-3 border-b border-theme flex items-center" [class.justify-between]="!collapsed()" [class.justify-center]="collapsed()">
        ...
        <button
          (click)="toggle.emit()"
          class="p-1.5 text-muted hover:text-heading active:text-orange-500 hover:bg-raised active:bg-inset active:scale-[0.98] rounded-lg transition-colors flex-shrink-0"
      ...
      <nav class="flex-1 p-2 space-y-0.5 overflow-y-auto overflow-x-hidden">
        <a routerLink="/dashboard" routerLinkActive="bg-orange-500/10 text-orange-500 border-orange-500"
           class="flex items-center px-3 py-2 text-muted rounded-lg hover:bg-raised active:bg-inset active:scale-[0.98] hover:text-heading active:text-orange-500 transition-colors border border-transparent"
      ...
      <div class="p-2">
        <button
          ...
          class="w-full flex items-center px-3 py-2 text-muted hover:text-heading active:text-orange-500 hover:bg-raised active:bg-inset active:scale-[0.98] rounded-lg transition-colors"
      ...
      <div class="p-2 border-t border-theme">
        ...
        <a routerLink="/profile" routerLinkActive="bg-raised"
           class="flex items-center p-2 rounded-lg hover:bg-raised active:bg-inset active:scale-[0.98] transition-colors"
      ...
      <div class="p-2 border-t border-theme">
        <button
          (click)="logout()"
          class="w-full flex items-center justify-center px-3 py-2 text-muted hover:text-red-500 active:text-red-600 hover:bg-red-500/10 active:bg-red-500/20 active:scale-95 rounded-lg transition-colors"
