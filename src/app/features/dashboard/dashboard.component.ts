    ...
    <div class="space-y-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
        ...
        <div class="card p-6">
          <div class="flex items-start justify-between">
            <div>
              <p class="text-gray-500 text-xs font-semibold uppercase tracking-wider">Active Projects</p>
              <p class="text-3xl font-extrabold text-white mt-2">{{ activeProjects() }}</p>
              <p class="text-gray-600 text-xs mt-1">Currently in progress</p>
            </div>
        ...
        <div class="card p-6">
          <div class="flex items-start justify-between">
            <div>
              <p class="text-gray-500 text-xs font-semibold uppercase tracking-wider">Pending Amount</p>
              <p class="text-3xl font-extrabold text-white mt-2">\${{ pendingAmount() | number: '1.0-0' }}</p>
        ...
        <div class="card p-6">
          <div class="flex items-start justify-between">
            <div>
              <p class="text-gray-500 text-xs font-semibold uppercase tracking-wider">Leads Won</p>
              <p class="text-3xl font-extrabold text-white mt-2">{{ wonLeadsCount() }}</p>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
        ...
        <div class="card p-6">
          ...
          <div class="space-y-3">
            <div class="flex items-center justify-between p-4 bg-gray-950 rounded-lg border border-gray-800">
              ...
              <p class="text-lg font-bold text-white">{{ activeClients() }}</p>
            </div>
            <div class="flex items-center justify-between p-4 bg-gray-950 rounded-lg border border-gray-800">
              <div class="flex items-center gap-3">
              ...
              <p class="text-lg font-bold text-white">{{ totalInvoices() }}</p>
            </div>
            <div class="flex items-center justify-between p-4 bg-gray-950 rounded-lg border border-gray-800">
              <div class="flex items-center gap-3">
                ...
                <p class="text-sm text-gray-400">Pipeline Leads</p>
              </div>
              <p class="text-lg font-bold text-white">{{ totalLeads() }}</p>
            </div>
          </div>
        </div>
          ...
          <div class="space-y-4">
            <div>
              <div class="flex justify-between text-xs mb-2">
                ...
                <span class="font-bold text-emerald-400">\${{ totalRevenue() | number: '1.0-0' }}</span>
              </div>
            ...
            <div>
              <div class="flex justify-between text-xs mb-2">
                ...
                <span class="font-bold text-amber-400">\${{ pendingOnly() | number: '1.0-0' }}</span>
              </div>
              <div class="w-full bg-gray-800 rounded-full h-2 overflow-hidden">
            ...
            <div>
              <div class="flex justify-between text-xs mb-2">
                ...
                <span class="font-bold text-red-400">\${{ overdueAmount() | number: '1.0-0' }}</span>
              </div>
              <div class="w-full bg-gray-800 rounded-full h-2 overflow-hidden">
...
export class DashboardComponent {
  ...
  wonLeadsValue = computed(() =>
    this.leadService.wonLeads().reduce((sum, l) => sum + l.value, 0)
  );
  ...
  private totalAmount = computed(() =>
    this.totalRevenue() + this.pendingOnly() + this.overdueAmount() || 1
  );

  revenueBarWidth = computed(() =>
    (this.totalRevenue() / this.totalAmount()) * 100
  );

  pendingBarWidth = computed(() =>
    (this.pendingOnly() / this.totalAmount()) * 100
  );

  overdueBarWidth = computed(() =>
    (this.overdueAmount() / this.totalAmount()) * 100
  );
}
